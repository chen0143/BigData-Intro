...
class SpERTTrainer(BaseTrainer):
    ...
    def __init__(self, args: argparse.Namespace):
        ...
        self._tokenizer.add_special_tokens({'additional_special_tokens':["[S:GN]","[/S:GN]","[O:CH]","[/O:CH]"]})
        # self._tokenizer.resize_token_embeddings()
        # print(self._tokenizer.add_special_tokens)_special
    ...
    def _load_model(self, input_reader):
        ...
        a=model.resize_token_embeddings(len(self._tokenizer))
        return model
        ...
        with torch.no_grad():
            ...
            for batch in tqdm(data_loader, total=total, desc='Evaluate epoch %s' % epoch):
                ...
                result = model(encodings=batch['encodings'], context_masks=batch['context_masks'],
                               ...
                               inference=True, entity_types = batch['entity_types'])
